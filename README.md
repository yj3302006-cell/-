...
Status: Final verification of deployment settings. Triggering build at 2026-05-01T10:38:00Z.
Manual fix: Standardized structure (moved main.tsx to src/), set base to './', and disabled hashing for predictable asset names.
Final check: GitHub Actions is confirmed to deploy the 'dist' folder with a working transformed index.html.
Deployment sync: 1.1.2 (Standardized Structure)
