    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-[#F5F5F0] flex items-center justify-center p-4" dir="rtl">
          <div className="bg-white p-8 rounded-[32px] shadow-xl border border-[#141414]/5 max-w-md w-full text-center font-sans font-medium">
            <div className="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center mx-auto mb-6">
              <AlertCircle className="text-red-600 w-8 h-8" />
            </div>
            <h2 className="text-2xl font-bold mb-4 text-[#141414]">אופס! אירעה שגיאה</h2>
            <p className="text-[#141414]/60 mb-8 leading-relaxed font-normal">
              {errorMessage}
            </p>
            <button
